...
const RelocateBoxFormMobile = ({ onSubmit, files, setFiles, loading }) => {
  const {
    register,
    control,
    handleSubmit,
  ...
  return (
    <form className={styles['relocate-box-form']} onSubmit={handleSubmit(onSubmit)}>
      <div className={styles['relocate-box-info-section']}>
...
RelocateBoxFormMobile.propTypes = {
...
export default RelocateBoxFormMobile;
