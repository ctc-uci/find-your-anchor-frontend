...
// NEED TO ADD THE LOGOUT MODAL TO THE MOBILE NAVBAR
        ...
        <div className={styles['page-content-container']}>
          <div className={styles['profile-form']}>
            ...
            <TextInput
              ...
              handleCheckMarkClicked={handleCheckMarkClicked}
            />
            <TextInput inputLabel="Email" fontSize="16px" placeHolder={email} editState={false} />
          </div>
          <div className={styles['bottom-buttons']}>
            ...
            {/* Will need to re-add this to the mobile navbar */}
            {/* <Button
