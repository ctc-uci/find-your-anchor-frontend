  ...
  return (
    <div className={styles['step-content']}>
      ...
      <ButtonGroup size="lg" className={styles['step-button-group']}>
        <Button onClick={closeModal} bg="#E2E8F0" fontSize="16px">
          Cancel
        </Button>
        <Button onClick={handleLogout} color="white" bg="#345E80" fontSize="16px">
          Logout
        </Button>
      </ButtonGroup>
    </div>
...
const ModalStepTwo = () => {
  ...
  return (
    <div className={styles['step-content']}>
      <Text fontSize="30px" fontWeight="bold" className={styles['step-text']}>
